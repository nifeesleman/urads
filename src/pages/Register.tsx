...
const Register = () => {
  ...
  const defaultRole = (searchParams.get("role") as Role) || "creator";
      ...
      <div className="hidden lg:flex flex-1 bg-primary items-center justify-center p-8">
        <div className="max-w-md text-center">
          ...
          <p className="text-primary-foreground/80 text-lg">
            {role === "creator"
              ? "Turn your influence into income. Connect with top brands and get paid for your creativity."
              : "Find the perfect creators for your campaigns. Reach millions of engaged followers."}
          </p>
        </div>
      </div>
